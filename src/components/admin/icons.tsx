/* Ikon SVG (stroke, currentColor) untuk panel admin — bukan emoji, mengikuti
   pedoman UX "no-emoji-icons" dan konsistensi stroke. Semua 24×24, stroke 2. */
...
export function PublicationIcon(p: IconProps) {
  return (
    <Svg {...p}>
      <path d="M12 7v14" />
